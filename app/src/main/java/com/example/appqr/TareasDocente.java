...
public class TareasDocente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tareas_docente);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        {
            Intent intent=new Intent(TareasDocente.this, Configuracion.class);
            startActivity(intent);
        }
        return super.onOptionsItemSelected(item);
    }

    public void llamarAgregarTarea(View view) {
        Intent intent=new Intent(TareasDocente.this, AgregarTareaDocente.class);
        startActivity(intent);
    }

    public void volvermenudocente(View view) {
        Intent intent=new Intent(TareasDocente.this, MenuDocente.class);
        startActivity(intent);
    }
        ...
        firebaseFirestore.collection("tblCursoDocente")
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<>(TareasDocente.this,
