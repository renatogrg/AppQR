...
public class AgregarTareaDocente extends AppCompatActivity {
    Spinner spnRegCurso;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregar_tarea_docente);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        {
            Intent intent=new Intent(AgregarTareaDocente.this, Configuracion.class);
    ...
    public void volvermenudocente(View view) {
        Intent intent=new Intent(AgregarTareaDocente.this, TareasDocente.class);
        startActivity(intent);
    }
        ...
        firebaseFirestore.collection("tblCursoDocente")
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<>(AgregarTareaDocente.this,
