...
public class TareasEstudiante extends AppCompatActivity {
    Spinner spnRegCurso;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        {
            Intent intent=new Intent(TareasEstudiante.this, Configuracion.class);
    ...
    public void volvermenuestudiante(View view) {
        Intent intent=new Intent(TareasEstudiante.this, MenuEstudiante.class);
        startActivity(intent);
    }
        ...
        firebaseFirestore.collection("tblCursoDocente")
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<>(TareasEstudiante.this,
